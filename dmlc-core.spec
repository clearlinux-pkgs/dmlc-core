...
%package abi
Summary: abi components for the dmlc-core package.
Group: Default

%description abi
abi components for the dmlc-core package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1542071574
mkdir -p clr-build
pushd clr-build
%cmake ..
...
%files abi
%defattr(-,root,root,-)
/usr/share/abi/libdmlc.so.1.abi
